...
- **Accession:** Dokumentiert den Erwerbungsprozess, also woher etwas kommt. Dies enthält oft vertrauliche Angaben, weswegen diese oft nicht öffentlich (*public*) gemacht werden. Die Beschreibung der Accession ist also eher Hintetergrundinformation. Sie ist wichtig aufzunehmen und steht beim Vorgang auch am Anfang, aber es ist nicht direkt relevant für die Beschreibung der Ressourcen.
...
(Überhaupt befinden sich auch andere Dinge erst im Edit-Modus, es lohnt sich also jeweils dort mal zu schauen.)
